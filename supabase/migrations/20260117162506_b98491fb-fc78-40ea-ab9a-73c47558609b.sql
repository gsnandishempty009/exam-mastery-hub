...
CREATE POLICY "Admins can manage question papers" ON public.question_papers FOR ALL USING (public.has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Admins can upload notes" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'notes' AND public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can update notes" ON storage.objects FOR UPDATE USING (bucket_id = 'notes' AND public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can delete notes" ON storage.objects FOR DELETE USING (bucket_id = 'notes' AND public.has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Admins can upload question papers" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'question-papers' AND public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can update question papers" ON storage.objects FOR UPDATE USING (bucket_id = 'question-papers' AND public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can delete question papers" ON storage.objects FOR DELETE USING (bucket_id = 'question-papers' AND public.has_role(auth.uid(), 'admin'));
